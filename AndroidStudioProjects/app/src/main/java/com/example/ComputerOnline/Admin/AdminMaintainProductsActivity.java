...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    private void displaySpecificProductInfo() {
        ...
        private void applyChanges () {
            ...
            if (pName.equals( "" )) {
                Toast.makeText( this, "Điền vào tên sản phẩm", Toast.LENGTH_SHORT ).show();
            } else if (pPrice.equals( "" )) {
                Toast.makeText( this, "Điền vào giá sản phẩm", Toast.LENGTH_SHORT ).show();
            } else if (pDescription.equals( "" )) {
                Toast.makeText( this, "Điền mô tả sản phẩm", Toast.LENGTH_SHORT ).show();
            } else {
                ...
                productsRef.updateChildren( productMap ).addOnCompleteListener( new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText( AdminMaintainProductsActivity.this, "Thay đổi thông tin sản phẩm thành công!", Toast.LENGTH_SHORT ).show();
